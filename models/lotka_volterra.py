...
class Model:
    """
    This is the lotka-volterra prey-predator model.
    x --> 2 x, c1
    x + y --> 2 y, c2
    y --> null, c3
...
args.state_upper_bound = int(3000)
args.init = [1000, 1000]
...
args.rate_parameters = (10, 0.01, 10)  # c1, c2, c3

# --------------------------------- gillespie simulation -------------------------------------#
args.end_time = 30
args.num_trajectories = 10
args.cpu_cores = 1
args.record_time_slices = 100
args.run_sim = True
args.save_sim = True
